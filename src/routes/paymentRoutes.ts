...
export default async (fastify: FastifyInstance) => {
  ...
  fastify.delete('/subscription/:subscriptionId', PaymentController.cancelSubscription);
  fastify.post('/donation', PaymentController.createDonation);
  fastify.post('/payment-method', PaymentController.updatePaymentMethod);
  fastify.post('/webhook', { config: { rawBody: true } }, PaymentController.handleWebhook);
};